...
const PlayerTable: React.FC<Props> = ({
  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-ink-200 bg-white shadow-sm no-scrollbar">
      <table className="w-full border-collapse text-sm">
        <thead className="sticky top-0 z-10 bg-ink-100">
          <tr>
            <th className="w-12 px-3 py-2 text-center text-xs font-semibold uppercase text-ink-700">
              Keep
            </th>
            <SortableHeader keyName="pprRank" className="w-16">Rank</SortableHeader>
            <SortableHeader keyName="name">Player</SortableHeader>
